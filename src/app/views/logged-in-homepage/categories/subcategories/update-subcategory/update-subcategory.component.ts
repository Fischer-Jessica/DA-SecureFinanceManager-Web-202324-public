      ...
      this.subcategoryService.getSubcategory(
        ...
        error => {
          if (error.status === 401) {
            ...
            this.snackBarService.showAlert(this.translateService.instant('logged-in-homepage.categories.subcategories.update-subcategory.alert_subcategory_not_found'), 'error');
          } else {
