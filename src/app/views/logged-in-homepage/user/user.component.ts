...
export class UserComponent implements OnInit {
   ...
   * @param {TranslateService} translateService - The TranslateService for localization.
  ...
  onSubmit(formData: User): void {
    ...
    this.userService.updateUser(
      ...
      updatedUser => {
        ...
        this.snackBarService.showAlert(this.translateService.instant('logged-in-homepage.user.alert_successful_update'), 'success');
      },
      error => {
        if (error.status === 401) {
          this.snackBarService.showAlert(this.translateService.instant('authentication.alert_user_not_logged_in'), 'info');
